...
public class SessionManager {
    ...
    public String createSession(String machineName) {
        ...
        // Create a NEW engine for this session (each session has its own engine)
        Engine engine = loaderManager.createNewEngine(machineName);
        if (engine == null) {
            throw new IllegalArgumentException("Failed to create engine for machine: " + machineName);
        }
